...
1. Use schema.sql (with your own bit.io username) to create a table in a bit.io Postgres database. You can copy the text directly into the bit.io [web query editor](https://docs.bit.io/docs/getting-started) and create the table from your browser. 

2.  Clone this repository  
```bash
git clone https://github.com/bitdotioinc/air-quality-logger.git
```
3. Navigate to the directory root  
```bash
